...
Это командный учебный проект, результатом которого является система для сбора сведений посредством опросов и их аналитика. Проект реализован на уровне MVP.
